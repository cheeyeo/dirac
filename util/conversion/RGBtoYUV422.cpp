/* ***** BEGIN LICENSE BLOCK *****
*
* $Id: RGBtoYUV422.cpp,v 1.3 2004/06/30 16:44:51 asuraparaju Exp $ $Name: Dirac_1_0_2 $
*
...
YUV422 is a planar format which stores the Y component of each frame,
...
int main(int argc, char * argv[] ) {
    ...
    if (argc != 4) {
        cout << "\"RGBtoYUV422\" command line format is:" << endl;
        ...
        cout << "    Example: RGBtoYUV422 <foo >bar 720 576 3" << endl;
